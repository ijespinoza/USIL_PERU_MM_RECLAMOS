		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Generación de Reclamo/Sugerencia",
									"targetURL": "#comindragestionreclamos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comindragestionreclamos-display": {
								"semanticObject": "comindragestionreclamos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.indra.gestionreclamos",
									"url": sap.ui.require.toUrl("com/indra/gestionreclamos")
								}
							}
						}
					}
